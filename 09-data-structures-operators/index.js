...
//     let [head, tail] = word.split('_');
//     const firstLetter = tail[0].toLowerCase().toUpperCase();
//     console.log(firstLetter);

//     const camelCase = `${head.toLowerCase().trim()}${firstLetter}${tail
//       .toLowerCase()
//       .trim()
//       .slice(1)}`;
//     const ticks = `${'✅'.repeat(num)}\n`;
//     finalStr += camelCase.padEnd(20, ' ') + ticks;
...
// console.log('Bff'.replace('B', 'B'.toUpperCase()));
